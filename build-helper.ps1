...
$MendixBase         = "C:\Program Files\Mendix\10.24.13.86719\modeler"
$StudioProExe       = "$MendixBase\studiopro.exe"
$ExtensionsDest     = "$MendixBase\Extensions\AideLite"

$ProjectDir         = "C:\Users\SathipathiSunil\Mendix Extension\AIDE-Lite"
$CsprojPath         = "$ProjectDir\src\AideLite.csproj"
$BuildOutput        = "$ProjectDir\src\bin\Release\net8.0-windows"

$MendixProjectPath  = "C:\Users\SathipathiSunil\Mendix\TestAIDE-main\TestAIDE.mpr"
